...
export const Dropdown = ({ label, children }: DropdownProps) => (
  <Root>
    <Trigger asChild>
      <button className="inline-flex w-56 min-w-36 items-center justify-between gap-2 rounded-md border border-neutral-900 bg-white px-5 py-3 text-base font-medium transition-colors hover:bg-neutral-50">
        {label}
